 ...
 * @since 1.4.0
 */
@Component("paramRuleRedisPublisher")
public class ParamRuleRedisPublisher implements DynamicRulePublisher<List<ParamFlowRuleEntity>> {
    ...
    public void publish(String app, List<ParamFlowRuleEntity> rules) throws Exception {
        ...
        redisConfigUtil.setString(RuleConstants.RULE_PARAM + app, strs);
    }
